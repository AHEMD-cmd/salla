...
class UserSubscriptionPolicy
{
    ...
    {
        return $user->can('view_any_user::subscription');
    }
    ...
    {
        return $user->can('view_user::subscription');
    }
    ...
    {
        return $user->can('create_user::subscription');
    }
    ...
    {
        return $user->can('update_user::subscription');
    }
    ...
    {
        return $user->can('delete_user::subscription');
    }
     ...
     */
    public function replicate(User $user, UserSubscription $userSubscription): bool
    {
